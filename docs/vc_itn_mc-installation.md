...
| Object        | UID         | API endpoint                                              |
|---------------|-------------|-----------------------------------------------------------|
| VC- Household | fT6xzEDXQAu | `../api/trackedEntityTypes.json?filter=name:eq:Household` |
...
If your TET Household already matches the one in the package and you want to avoid overriding the current sharing properties for this object in the database, you can follow these steps:
...
### Adapting the tracker and event programs
...
* Adapting the Category Combo used in the Event program to use category options for the years you are doing the campaigns
